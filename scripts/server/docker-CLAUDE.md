...
- **Monitoring scripts and email pipeline:** See `~/docker/monitoring.md` for the full reference: health-monitor, temp-monitor, vpn-diskcheck, server-check, ups-charge-log, Proton Bridge / msmtp email setup, bridge-watchdog, and the complete cron schedule.
