...
- `arrs-compose` — After docker, wg0, mnt-data (Requires all three)
- `filebrowser-compose` — After docker, wg0, mnt-data (Requires all three)
- `homepage-compose` — After docker, wg0, mnt-data, mnt-immich-backup, immich-compose; Requires docker, mnt-data, mnt-immich-backup, immich-compose (needs the `immich_default` network to exist, and bind-mounts the backup drive read-only — **a dead/unmounted sda blocks Homepage from starting**)
- `immich-compose` — After docker, wg0, mnt-data (Requires all three)
