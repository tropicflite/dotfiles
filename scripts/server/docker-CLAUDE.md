...
|---------|--------|--------|---------|
| `arrs` | (default) | — | Shared by arrs stack, jellyfin, qbittorrent, homepage, uptime-kuma, ntfy, stirling-pdf, filebrowser, scrutiny, recyclarr, nut-webgui, and tsdproxy; allows inter-container name resolution |
